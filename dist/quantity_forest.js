    ...
    $.fn.quantity_forest = function (options, element) {
        ...
        element.draw_forest = function () {
            ...
            var initial_group = {
                ...
                members: settings.roots.map(function (root) {
            ...
            var format_groups = function (groups, level) {
                ...
                for (var g = 0; g < groups.length; g++) {
                        ...
                        if (root.expanded && root.children) {
                            ...
                            if (children.length > 0) {
                                let new_group = {
                                    parent: member,
                                    frame: level_frame,
                                    members: children.map(function (root) {
                    ...
                    if (group.parent) {
                        ...
                        var points = [[group.x_start, settings.dy], [group.parent.x_start + shift, back_y], [group.parent.x_end - shift, back_y], [group.x_end, settings.dy]];
