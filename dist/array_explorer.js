...
(function ($) {
    ...
    $.fn.array_explorer = function (options, element) {
        ...
        var draw_array = function () {
            ...
            nrows = row_names.length;
            ncols = column_names.length;
            array_frame.set_region(0, 0, width, height, 0, nrows, ncols, 0);
        ...
        var draw_charts = function () {
            ...
            // top row chart frame
            top_frame.set_region(0, height + spacer, width, height + cheight + spacer, 0, min_value, ncols, max_value);
            ...
            left_axis_frame.set_region(-spacer, 0, -cwidth - spacer, height, min_value, 0, max_value, nrows);
        ...
        var selection_charts = function (row, col, color_override, offset) {
            ...
            charts.draw = function () {
                ...
                charts.top_frame = element.frame_region(0, height + spacer, width, height + cheight + spacer, 0, min_value, ncols, max_value);
                charts.left_frame = element.frame_region(-spacer, 0, -cwidth - spacer, height, min_value, nrows, max_value, 0);
                ...
                if (charts.row == selected_row) {
                    ...
                    charts.rightframe = element.frame_region(width + spacer + cwidth, height + spacer + rightoffset, width + spacer + cwidth * 2, height + spacer + cheight + rightoffset, 0, min_value, right_bin_max, max_value);
                    // background
                    ...
                    charts.rightframe = element.frame_region(width + spacer + cwidth, height + spacer + rightoffset, width + spacer + cwidth * 2, height + spacer + cheight + rightoffset, min_value, min_value, max_value, max_value);
                    // background
                    charts.rightframe.frame_rect({
                ...
                if (charts.col == selected_col) {
                    ...
                    charts.bottomframe = element.frame_region(bottomoffset - cwidth - spacer, -cwidth * 2 - spacer, bottomoffset - spacer, -cwidth - spacer, max_value, 0, min_value, bottom_bin_max);
                    // background
                    ...
                    charts.bottomframe = element.frame_region(bottomoffset - cwidth - spacer, -cwidth * 2 - spacer, bottomoffset - spacer, -cwidth - spacer, max_value, min_value, min_value, max_value);
                    // background
                    charts.bottomframe.frame_rect({
                        x: min_value, y: min_value, w: max_value - min_value, h: max_value - min_value, color: settings.background
                    });
            ...
            charts.remove = function () {
                ...
                if (charts.top_frame) {
                    element.forget_objects([charts.top_frame, charts.rightframe, charts.left_frame, charts.bottomframe, charts.array_rect, charts.column_outline, charts.row_outline]);
                }
            };
            return charts;
        };
        ...
        var draw_color_bar = function () {
            ...
            color_frame.set_region(-color_width - cwidth - 2 * spacer, 0, -cwidth - 2 * spacer, height, 0, min_value, 1, max_value);
    ...
    $.fn.array_explorer.example = function (element) {
        var column_names = ['Th0_0.5h_1_1', 'Th0_14h_4_1', 'Th0_16h_1_1', 'Th0_16h_7_1', 'Th0_18h_5_1', 'Th0_1h_1_1', 'Th0_20h_5_1', 'Th0_20h_6_1', 'Th0_25h_6_1', 'Th0_2h_2_1', 'Th0_2h_7_1', 'Th0_30h_6_1', 'Th0_30h_9_1', 'Th0_36h_6_1', 'Th0_42h_6_1', 'Th0_42h_7_1', 'Th0_48h_6_1', 'Th0_4h_3_1', 'Th0_54h_6_1', 'Th0_54h_7_1'];
        var row_names = ['0610007p14rik', '0610012g03rik', '1190002n15rik', '1500010j02rik', '1700081l11rik', '2010002n04rik', '2010109k11rik', '2310004i24rik', '2310008h04rik', '2310033p09rik', '2610019f03rik', '2810021b07rik', '3110003a17rik', '3110057o12rik', '4632428n05rik', '4930420k17rik', '4930583h14rik'];
