...
(function($) {
    ...
    $.fn.canvas_2d_vector_field = function (options, element) {
        ...
        var color_interpolator = element.color_interpolator(
            settings.initial_color, settings.final_color,
        );
    ...
    $.fn.canvas_2d_vector_field.example = function (element) {
        ...
        var f_options = {
            ...
            radius: 0.1,
            motions: [
                {sx: 0, sy:0, ex: 0, ey: 1, dt: 1},
                {sx: 0, sy:1, ex: 1, ey: 1, dt: 1},
                {sx: 1, sy:1, ex: 1, ey: 0, dt: 1},
                {sx: 1, sy:0, ex: 0, ey: 0, dt: 1},
            ]
        };
